...
Ns3QuicAlarmEngine::Ns3QuicAlarmEngine(Perspective role)
    : role_(role), visitor_(nullptr) {}
Ns3QuicAlarmEngine::~Ns3QuicAlarmEngine() { Shutdown(); }
...
Ns3QuicAlarmEngine::AlarmRegToken
Ns3QuicAlarmEngine::ReregisterAlarm(AlarmRegToken &iterator_token,
                                    int64_t timeout_us) {
...
void Ns3QuicAlarmEngine::UpdateTimer() {
  ...
  NS_ASSERT_MSG(future_us >= now_us,
                now_us << ":" << future_us << ":" << alarm_map_.size());
...
public:
  Ns3Alarm(Ns3QuicAlarmEngine *engine,
           QuicArenaScopedPtr<QuicAlarm::Delegate> delegate)
      : QuicAlarm(std::move(delegate)), engine_(engine), ns3_alarm_impl_(this) {
  }
...
Ns3AlarmFactory::Ns3AlarmFactory(Ns3QuicAlarmEngine *engine)
    : engine_(engine) {}
...
QuicArenaScopedPtr<QuicAlarm>
Ns3AlarmFactory::CreateAlarm(QuicArenaScopedPtr<QuicAlarm::Delegate> delegate,
