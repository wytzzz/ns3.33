...
public:
  ...
  AlarmRegToken ReregisterAlarm(AlarmRegToken &iterator_token,
                                int64_t timeout_us);
  std::string Name();
...
public:
  ...
  virtual void OnRegistration(const Ns3QuicAlarmEngine::AlarmRegToken &token,
                              Ns3QuicAlarmEngine *engine) = 0;
...
public:
  ...
  CreateAlarm(QuicArenaScopedPtr<QuicAlarm::Delegate> delegate,
