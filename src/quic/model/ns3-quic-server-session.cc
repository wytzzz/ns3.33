...
Ns3QuicServerSession::Ns3QuicServerSession(
  ...
  /*for (const ParsedQuicVersion& version : supported_versions){
      QUIC_BUG_IF(Ns3QuicServerSession,version.handshake_protocol !=
  PROTOCOL_TLS1_3)
      << "QuicTransport requires TLS 1.3 handshake";
  }*/
  static Ns3QuicTransportServerCryptoHelper *helper =
      new Ns3QuicTransportServerCryptoHelper();
...
QuicStream *
Ns3QuicServerSession::CreateIncomingStream(PendingStream * /*pending*/) {
  return nullptr;
}
