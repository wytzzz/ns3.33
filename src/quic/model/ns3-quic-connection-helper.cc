...
namespace quic {
Ns3QuicConnectionHelper::Ns3QuicConnectionHelper(
    QuicAllocatorType allocator_type)
    : random_generator_(QuicRandom::GetInstance()),
      clock_(Ns3QuicClock::Instance()), allocator_type_(allocator_type) {}
Ns3QuicConnectionHelper::~Ns3QuicConnectionHelper() = default;
const QuicClock *Ns3QuicConnectionHelper::GetClock() const { return clock_; }
