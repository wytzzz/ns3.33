...
void print_address() {
  {
    ...
    quic::QuicSocketAddress quic_socket_addr =
        ns3::GetQuicSocketAddr(ns3_socket_addr);
  ...
  }
  {
    ...
    ns3::InetSocketAddress ns3_socket_addr =
        ns3::GetNs3SocketAddr(quic_socket_addr);
    std::cout << ns3_socket_addr.GetIpv4() << ":" << ns3_socket_addr.GetPort()
              << std::endl;
  }
}
void test_quic_log() {
