...
Ns3QuicServer::Ns3QuicServer(std::unique_ptr<ProofSource> proof_source,
    ...
    : Ns3QuicServer(std::move(proof_source), AllSupportedVersions(), engine,
                    backend) {}
...
Ns3QuicServer::Ns3QuicServer(std::unique_ptr<ProofSource> proof_source,
                             ...
                             Ns3QuicAlarmEngine *engine,
                             Ns3QuicBackendBase *backend)
    : Ns3QuicServer(std::move(proof_source), QuicConfig(),
                    QuicCryptoServerConfig::ConfigOptions(), supported_versions,
                    kQuicDefaultConnectionIdLength, engine, backend) {}

Ns3QuicServer::Ns3QuicServer(
    std::unique_ptr<ProofSource> proof_source, const QuicConfig &config,
    const QuicCryptoServerConfig::ConfigOptions &crypto_config_options,
    const ParsedQuicVersionVector &supported_versions,
    uint8_t expected_server_connection_id_length, Ns3QuicAlarmEngine *engine,
    Ns3QuicBackendBase *backend)
    : config_(config),
...
QuicDispatcher *Ns3QuicServer::CreateQuicDispatcher() {
  ...
  std::unique_ptr<QuicCryptoServerStreamBase::Helper> session_helper(
      new Ns3QuicCryptoServerStreamHelper);
  return new Ns3QuicDispatcher(
      ...
      expected_server_connection_id_length_, backend_);
}
