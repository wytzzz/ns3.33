...
HelloClientEndpoint::HelloClientEndpoint(Ns3QuicBackendBase *backend,
                                         bool bidi_channel)
    : Ns3QuicEndpointBase(backend), bidi_channel_(bidi_channel) {}
...
void HelloClientEndpoint::OnIncomingBidirectionalStream(
    Ns3TransportStream *stream) {}
void HelloClientEndpoint::OnIncomingUnidirectionalStream(
    Ns3TransportStream *stream) {}
...
void EchoServerEndpoint::OnIncomingBidirectionalStream(
    Ns3TransportStream *stream) {
...
void EchoServerEndpoint::OnIncomingUnidirectionalStream(
    Ns3TransportStream *stream) {
...
HelloClientBackend::HelloClientBackend(Ns3QuicAlarmEngine *engine,
                                       bool bidi_channel)
    : Ns3QuicBackendBase(engine), bidi_channel_(bidi_channel) {}

Ns3QuicEndpointBase *
HelloClientBackend::CreateEndpoint(Ns3QuicSessionBase *session) {
...
Ns3QuicEndpointBase *
HelloServerBackend::CreateEndpoint(Ns3QuicSessionBase *session) {
...
void BandwidthClientEndpoint::OnIncomingBidirectionalStream(
    Ns3TransportStream *stream) {}
void BandwidthClientEndpoint::OnIncomingUnidirectionalStream(
    Ns3TransportStream *stream) {}
...
void BandwidthServerEndpoint::OnIncomingBidirectionalStream(
    Ns3TransportStream *stream) {}
void BandwidthServerEndpoint::OnIncomingUnidirectionalStream(
    Ns3TransportStream *stream) {
...
BandwidthClientBackend::BandwidthClientBackend(Ns3QuicAlarmEngine *engine)
    : Ns3QuicBackendBase(engine) {}
Ns3QuicEndpointBase *
BandwidthClientBackend::CreateEndpoint(Ns3QuicSessionBase *session) {
...
BandwidthServerBackend::BandwidthServerBackend(Ns3QuicAlarmEngine *engine)
    : Ns3QuicBackendBase(engine) {}
Ns3QuicEndpointBase *
BandwidthServerBackend::CreateEndpoint(Ns3QuicSessionBase *session) {
