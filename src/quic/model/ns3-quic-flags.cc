...
DEFINE_QUIC_COMMAND_LINE_FLAG(int32_t, test_value, 123,
...
DEFINE_QUIC_COMMAND_LINE_FLAG(bool, quic_ietf_draft, false,
...
DEFINE_QUIC_COMMAND_LINE_FLAG(
    ...
    "negotiation.");
namespace quic {
int get_test_value() { return GetQuicFlag(FLAGS_test_value); }
std::string get_quic_version() { return GetQuicFlag(FLAGS_quic_version); }
bool get_quic_ietf_draft() { return GetQuicFlag(FLAGS_quic_ietf_draft); }
